...
export const SearchAgentSection = () => {
  ...
  const handleSearch = () => {
    ...
    setIsLoading(true);
    // Simulación - luego se conectará con IA real
    setTimeout(() => {
      setIsLoading(false);
    }, 2000);
  };
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            Describe lo que buscas en lenguaje natural y nuestro agente de IA te ayudará a encontrar el dataset
            ideal con la calidad que necesitas.
          </p>
        </motion.div>
